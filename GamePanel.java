...
public class GamePanel extends JPanel implements Runnable{
	...
	public GamePanel(AI ai, Paddle human, Ball ball) { 
		...
		paddle1 = new Paddle(PADDLE_X_OFFSET, GAME_HEIGHT / 2 - PADDLE_HEIGHT / 2, PADDLE_WIDTH, ball);
        ai = new AI(GAME_WIDTH - PADDLE_X_OFFSET - PADDLE_WIDTH, GAME_HEIGHT / 2 - PADDLE_HEIGHT / 2, PADDLE_WIDTH, PADDLE_HEIGHT, flags, ball);  
	...
	public void newPaddles() {
		paddle1 = new Paddle(0, (GAME_HEIGHT/2) - (PADDLE_HEIGHT/2), PADDLE_WIDTH, ball);
		paddle2 = new Paddle(GAME_WIDTH - PADDLE_WIDTH, (GAME_HEIGHT/2) - (PADDLE_HEIGHT/2), PADDLE_WIDTH, ball);
	}
